...
:bookmark_tabs: [Legacy server endpoint catalog](docs/legacy-protocol/endpoints.md)
...
:bookmark_tabs: [Offline items normalization build](packages/game-content/README.md)
