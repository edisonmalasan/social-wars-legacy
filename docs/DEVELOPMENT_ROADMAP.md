...
- **Current objective:** proposal stage for `godot-compatibility-boot` — artifacts written and strict-validated; commit, push, PR into `main`, then Apply on `feat/godot-compatibility-boot`. Prior context: `first-render-in-godot` lifecycle closed (archive PR #114 `9208e2b`, sync PR #113 `4af07a5`, Apply PR #112 `daaa40c`, proposal PR #111 `e745466`); Godot 4.7.2 installed and pinned (docs PR #110, `615c739`).
